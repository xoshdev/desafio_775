...
class ApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application" do
    assert_difference("Application.count") do
      post applications_url, params: { application: { job_id: @application.job_id, user_id: @application.user_id } }
    end
  ...
  test "should update application" do
    patch application_url(@application), params: { application: { job_id: @application.job_id, user_id: @application.user_id } }
